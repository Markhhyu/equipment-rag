"""Bailian WebSearch MCP configuration."""
...
mcp_config = McpConfig(
    ...
    api_key=(os.getenv("MCP_DASHSCOPE_API_KEY") or "").strip(),
    ...
    timeout_seconds=float(os.getenv("MCP_DASHSCOPE_TIMEOUT_SECONDS") or "60"),
)

client_session_timeout_seconds = mcp_config.timeout_seconds,
