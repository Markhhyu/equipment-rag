...
from app.knowledge_trust import normalize_trust_level
...
from app.security.tenancy import safe_upload_filename, tenant_filter, tenant_object_prefix
...
@app.get("/knowledge/documents", tags=["knowledge-governance"])
...
@app.post("/knowledge/legacy/register", tags=["knowledge-governance"])
...
@app.get("/knowledge/documents/{document_id}", tags=["knowledge-governance"])
...
@app.post(
    "/knowledge/documents/{document_id}/versions/{revision_id}/publish",
...
@app.post(
    "/knowledge/documents/{document_id}/versions/{revision_id}/rollback",
    tags=["knowledge-governance"],
)
...
@app.post("/knowledge/documents/{document_id}/disable", tags=["knowledge-governance"])
...
@app.post("/knowledge/documents/{document_id}/enable", tags=["knowledge-governance"])
...
@app.get("/knowledge/audit", tags=["knowledge-governance"])
